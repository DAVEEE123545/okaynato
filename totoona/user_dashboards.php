 ...
 function dashboard() {
  ...
  <style>
        ...
        .summary-card {
            ...
            text-align: center;
            color: white;
            box-shadow: 0 4px 8px rgba(6, 8, 6, 5.2);
        ...
        .bulletin-card:hover {
            transform: translateY(-5px);
            box-shadow: 0 4px 8px rgba(6, 8, 6, 7.2);
        }
...
.info-section h2 {
    color:#141db8; /* Updated color */
    font-weight: bold;
    text-transform: uppercase; /* Optional for uppercase heading */
    border-bottom: 2px solid #757be6; /* Line under the heading */
    padding-bottom: 10px;
}
